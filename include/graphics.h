...
extern const u8 gMonFrontPic_Burmy[];
extern const u8 gMonPalette_Burmy[];
extern const u8 gMonBackPic_Burmy[];
extern const u8 gMonShinyPalette_Burmy[];
extern const u8 gMonIcon_Burmy[];
extern const u8 gMonFrontPic_Wormadam[];
extern const u8 gMonPalette_Wormadam[];
extern const u8 gMonBackPic_Wormadam[];
extern const u8 gMonShinyPalette_Wormadam[];
...
extern const u8 gMonFrontPic_Shellos[];
extern const u8 gMonPalette_Shellos[];
extern const u8 gMonBackPic_Shellos[];
extern const u8 gMonShinyPalette_Shellos[];
extern const u8 gMonIcon_Shellos[];
extern const u8 gMonFrontPic_Gastrodon[];
extern const u8 gMonPalette_Gastrodon[];
extern const u8 gMonBackPic_Gastrodon[];
extern const u8 gMonShinyPalette_Gastrodon[];
...
extern const u8 gMonFrontPic_Mime_Jr[];
extern const u8 gMonPalette_Mime_Jr[];
extern const u8 gMonBackPic_Mime_Jr[];
extern const u8 gMonShinyPalette_Mime_Jr[];
extern const u8 gMonIcon_Mime_Jr[];
...
extern const u8 gMonFrontPic_Porygon_Z[];
extern const u8 gMonPalette_Porygon_Z[];
extern const u8 gMonBackPic_Porygon_Z[];
extern const u8 gMonShinyPalette_Porygon_Z[];
...
extern const u8 gMonFrontPic_Rotom[];
extern const u8 gMonPalette_Rotom[];
extern const u8 gMonBackPic_Rotom[];
extern const u8 gMonShinyPalette_Rotom[];
...
extern const u8 gMonFrontPic_Meowstic[];
extern const u8 gMonPalette_Meowstic[];
extern const u8 gMonBackPic_Meowstic[];
extern const u8 gMonShinyPalette_Meowstic[];
